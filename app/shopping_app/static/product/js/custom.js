...
----------------------------------------------------- */
    ...
    $(window).resize(function () {
        ...
        if ($screensize > 1199) {
            $(
                "#menu .nav > li.mega-menu > div .clearfix.visible-lg-block"
            ).remove();
            $("#menu .nav > li.mega-menu > div > .column:nth-child(6n)").after(
                '<div class="clearfix visible-lg-block"></div>'
            );
...
----------------------------------------------------- */
    $(document).on("click", "#grid-view", function (e) {
        $("#content .product-layout").attr(
            "class",
            "product-layout product-grid col-lg-5ths col-md-5ths col-sm-3 col-xs-12"
        );

        $screensize = $(window).width();
        if ($screensize > 1199) {
            $(".products-category > .clearfix").remove();
            $(".product-grid:nth-child(5n)").after(
