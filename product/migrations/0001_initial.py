    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True, max_length=60, unique=True, verbose_name='آدرس')),
                ('color', colorfield.fields.ColorField(default='#FF0000', max_length=18, verbose_name='رنگ')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product.color', verbose_name='رنگ تشک')),
            ],
            options={
                'verbose_name': 'تشک',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True, max_length=60, unique=True, verbose_name='آدرس')),
                ('two_poeple', models.BooleanField(blank=True, default=False, null=True, verbose_name='دو نفره')),
                ('status', models.BooleanField(default=False, verbose_name='وضعیت موجودی')),
            ],
            options={
                'verbose_name': 'مدل',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=0, default_currency='IRR', max_digits=9, verbose_name='قیمت')),
                ...
                ('body_color', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product.color', verbose_name='رنگ بدنه')),
                ('mattress', models.ManyToManyField(to='product.Mattress', verbose_name='تشک')),
                ('pattern', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product.pattern', verbose_name='مدل')),
            ],
            options={
                'verbose_name': 'محصول',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True, max_length=60, unique=True, verbose_name='آدرس')),
                ('tie', models.IntegerField(blank=True, null=True, verbose_name='تعداد گره')),
                ('status', models.BooleanField(default=False, verbose_name='وضعیت موجودی')),
            ],
            options={
                'verbose_name': 'بافت',
        ...
        migrations.AddField(
            model_name='product',
            name='texture',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product.texture', verbose_name='بافت'),
        ),
    ]
